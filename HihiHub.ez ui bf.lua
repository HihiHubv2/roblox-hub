...
e.Image = "rbxassetid://124030542360590";
e.Visible = false;
local a = Instance.new("UICorner");
a.Name = "MCNR";
a.Parent = e;
...
do
	if game:GetService("CoreGui"):FindFirstChild("HihiHub") then
...
a.Window = function(self, f, f, f)
	...
	j.Image = "rbxassetid://124030542360590";
	...
	d.Tab = function(self, d, f)
		...
		a.Toggle = function(self, a, b, d)
			...
			o.Image = "rbxassetid://124030542360590";
			j.Parent = h;
		...
		a.Dropdown = function(self, a, b, d)
			...
			f.Image = "rbxassetid://124030542360590";
			k.Name = "DropTitle";
			k.Parent = g;
			k.BackgroundColor3 = Color3.fromRGB(41, 53, 61);
			k.BackgroundTransparency = 1;
		...
		a.Slider = function(self, a, c, d, e, g)
			...
			l.Image = "rbxassetid://124030542360590";
			m.Parent = j;
		...
		a.Slider2 = function(self, a, b, c, d, e)
			...
			k.Image = "rbxassetid://124030542360590";
			l.Parent = i;
