...
local a = "https://raw.githubusercontent.com/HihiHubv2/roblox-hub/refs/heads/main/HihiHub.ez%20ui%20bf.lua"
local a = loadstring(game:HttpGet(a,true))()
local a = a:Window("BloxFruit")
local Set = a:Tab("Settings Farm ", "")
local Main = a:Tab("Auto Farm", "")
local Farm = a:Tab("Item Quest", "")
local Event = a:Tab("Sea Event", "")
local Stats = a:Tab("Auto Stats", "")
local Tele = a:Tab("World Tele", "")
local Player = a:Tab("Player Pvp", "")
local Race = a:Tab("Race V4", "")
local Raid = a:Tab("Dungeon Raid", "")
local DemonFruit = a:Tab("Fruit Demon", "")
local Esp = a:Tab("Esp Player", "")
local Shop = a:Tab("Shopee", "")
local Misc = a:Tab("Miscellaneous", "")
-----------------------------------------------------------------------------------------------------------------------------Function
